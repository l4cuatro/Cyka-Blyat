...
#pragma config(Motor,  port1,           lChain,        tmotorVex393_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port4,           lGoal,         tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           mlDrive,       tmotorVex393HighSpeed_MC29, openLoop, driveLeft, encoderPort, dgtl1)
...
#pragma config(Motor,  port10,          rChain,        tmotorVex393_HBridge, openLoop)
